...
--
-- Table structure for table `hñ9~[­aêr×âþ·mû{àæctñ·ãð/ãg!þ1×ï~ñ¯]ðpæüð!¾ %põa`
--

DROP TABLE IF EXISTS `hñ9~[­aêr×âþ·mû{
àæctñ·ãð/ãg!þ1×ï~ñ¯]ðpæüð!¾
 %põa`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `hñ9~[­aêr×âþ·mû{
àæctñ·ãð/ãg!þ1×ï~ñ¯]ðpæüð!¾
 %põa` (
  `a6` int(11) DEFAULT NULL,
  `NïßCO	dQ|©îNfF]cÙªÊB6a*ýei4÷(9ãd` year(4) NOT NULL DEFAULT '0000',
  `ïgâÅÈWÖ_ÿÝÑH8¿úÛ ^ìWYiøJSèÅâFµAçG
¡ÀÜVò¿ßnäX` decimal(64,0) DEFAULT '0',
  `å ]![¥ô*[tw²TÔJùÃÜ)~´öÚTØ¡` multipolygon NOT NULL,
  `S½R¦5êðQå[¨ÕÝ­R°@oÏX6*G^éØÔ,$ùÐÖmT×3³m+&Ñú6J»Á;S` polygon NOT NULL,
  `Ð<¹(¨_ûtLB¹ÒpE¸n¯§I1Ë9£ØiMq]©cðÐ¯¬"½çÆ²>T` binary(1) NOT NULL,
  `â 81Îèdä3Ô}IN
yþ8Êh pîÂõGó_ýG5/` date NOT NULL DEFAULT '2012-04-18',
  `füE±EüröjFø¸Y¨ìë+_±s)&Jª£
ñ!ÅÚ¤3A9z.ã "S` decimal(52,2) NOT NULL DEFAULT '100000.00',
  `ìkIµã¦Æ¹7'¸£é­` date NOT NULL DEFAULT '2013-05-22',
  `Ù~Ã` double NOT NULL DEFAULT '-1.389e74',
  PRIMARY KEY (`â 81Îèdä3Ô}IN
yþ8Êh pîÂõGó_ýG5/`),
  KEY `idx31` (`â 81Îèdä3Ô}IN
yþ8Êh pîÂõGó_ýG5/`),
  KEY `idx33` (`â 81Îèdä3Ô}IN
yþ8Êh pîÂõGó_ýG5/`),
  KEY `idx35` (`â 81Îèdä3Ô}IN
yþ8Êh pîÂõGó_ýG5/`),
  KEY `idx36` (`å ]![¥ô*[tw²TÔJùÃÜ)~´öÚTØ¡`),
  KEY `idx37` (`ìkIµã¦Æ¹7'¸£é­`),
  KEY `idx38` (`a6`),
  KEY `idx40` (`â 81Îèdä3Ô}IN
yþ8Êh pîÂõGó_ýG5/`),
  KEY `idx41` (`a6`),
  KEY `idx43` (`â 81Îèdä3Ô}IN
yþ8Êh pîÂõGó_ýG5/`),
  KEY `idx45` (`â 81Îèdä3Ô}IN
yþ8Êh pîÂõGó_ýG5/`),
  KEY `idx46` (`füE±EüröjFø¸Y¨ìë+_±s)&Jª£
ñ!ÅÚ¤3A9z.ã "S`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `;zèãsíçñózâ~fåèè¯íú6wzfcüôøj£	¡ñéæú·'ôbîaráè®`
--

DROP TABLE IF EXISTS `;zèãsíçñózâ~fåèè¯íú6wzfcüôøj£	¡ñéæú·'ôbîaráè®`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `;zèãsíçñózâ~fåèè¯íú6wzfcüôøj£	¡ñéæú·'ôbîaráè®` (
  `a1` int(11) DEFAULT NULL,
  `èFàVa²N0¿ûcDJÿ{£` time DEFAULT '04:46:16',
  `(ûòRîVDÂfnòT®` point NOT NULL,
  `7ñv±D"/Ý»þÉ@üêáO7Bïg0±ò9ü*xoý¸V©s²*¸&+` int(11) DEFAULT '0',
  `*` decimal(56,22) NOT NULL DEFAULT '844.0000000000000000000000',
  `º¹ÙÅ@aN}Ñ½Mó-°/4ýûà¸k<+½I$¨§©d7I` datetime NOT NULL DEFAULT '2012-08-16 13:21:22',
  `¡uï[@E9Oí¾«å>^¤róm87vq¥ÕÙÑEÍPæÛªêW¼&ò«±NøØæï<íIH¦` int(10) unsigned NOT NULL DEFAULT '100001',
  `@&` mediumint(8) unsigned zerofill NOT NULL DEFAULT '00000442',
  `ÇÉ¸°fjo0¦7ÚøTq` point NOT NULL,
  `YOànfç¶|?ôh¤½â9C¿àebT^µj` date NOT NULL DEFAULT '2012-08-09',
  `ÉÕHuõ»îÕ¯3ÖqÃä/53¥§:¹` geometrycollection NOT NULL,
  `ÖÑÌÄX` timestamp NOT NULL DEFAULT '2013-04-02 11:48:43',
  `}kïÃ¿0¬ðqKa60ç:¾¡;Ta#m´,¡e4W¥` int(10) unsigned NOT NULL DEFAULT '100001',
  `ùº¨0%Ìxs]%øÃëÊ?U` double NOT NULL DEFAULT '9.698453e95',
  `ÔÑeÑL%íô¯×®á²¯Eà3¥h¢aÝ&É¦<_ØÃôF_BiNþ*d	h®÷çûEÛ` time DEFAULT '12:30:22',
  `kà0£ðm I÷éC-ôWÝ-ëì,Ä\Æ¢ôñRî¨aÃ~vO` enum('vlpcllxfrk','yuckuq','emilsrwh','oaifgwfdgd','xuivqpnnc','nbmwdxkcc','m','eiwczyju','ffpxxuva','cc','rsileffjb','','ztcirklchd','egcragsl','','','mrrltyukri','lomgafa','haosb','wacroxiihg','b','whfkc','uvztcjsugk','khticyzeb','','xeqw','','mf','lthglquszp','cuhcxwk','','xg','qpu','v','dumjmg','pvtwuqpzny','cj','lqbzrdm','vyjnjchvsm','hp','nbsl','aei','gicdaejjjv','vhzyr','uutrxpfgg','iuhkeawsl','ov','bvfy','mty','hqoypgrgdo','krylhgdu','nniby','f','pfopctgscb','mzw','u','ipw','yhwbvebaxd','ed','rvdljzz') NOT NULL,
  `¦?Jjá¦~.F¨	a£Z^»;ê` timestamp NOT NULL DEFAULT '2012-08-10 09:14:54',
  `=~0` linestring NOT NULL,
  `Ä{XPH^;ÞÛâä|+ßbûª%&«` decimal(20,11) unsigned DEFAULT '1482.99600000000',
  `ÎY,w¡Z«s>ÿúÙ÷éßõ2Êû«3´ê8é'mñ}XRÝ¨` decimal(63,28) NOT NULL DEFAULT '-99999.0000000000000000000000000000',
  `±` decimal(56,7) unsigned DEFAULT '0.0000000',
  `Zcï3÷Ë³¾aÈ©J` decimal(62,12) NOT NULL DEFAULT '99999.000000000000',
  `þîRºÚµoe0üRëÔïdAKb2C	ø< öísS"S¼@¡]ýc%G` mediumblob NOT NULL,
  `ôR*ýÝÏFÊÇg3¾\Kg¬p¡p¶ÃÕÑ®ý
Ä` varchar(176) CHARACTER SET utf8 NOT NULL DEFAULT 'amuprygbcxgp',
  `tev+·¿# úPÏ` point NOT NULL,
  `ýÉ{cm"ðOÅ.Ö¨Ç` year(4) DEFAULT '0000',
  `zpÜ·©ºsúpÜ¿tXþ¿
e}UqJQ~WèKÃQ*÷Ä»` datetime NOT NULL DEFAULT '2012-05-28 21:02:41',
  `KÍP_ý)\joÚÒæ2ÿ(yxTÈuÊÜ³½Vp¤CÙ` decimal(33,28) DEFAULT '0.0000000000000000000000000000',
  `Ru-Ù?
D?Ì!ÛyVTÌ-ã` datetime NOT NULL DEFAULT '2013-09-09 22:20:10',
  `o-bsÕ*àË]*\7ÿlí!ª²è­y¼en;J'ª¨³R1ò6;Éz¢` mediumint(9) NOT NULL DEFAULT '38',
  `CÈa5SýH'Ê¯C¤6Leöf=À|.D¥ÜO$ d.6_Çÿ¤½è\	¹Y¿` tinyblob NOT NULL,
  `)ø2ÛáDÜaâ8Rè«®L` decimal(36,13) DEFAULT '0.0000000000000',
  `Ë¯XBa°äñ]$Ô~ßsa4¥úÞÛOA«` point DEFAULT NULL,
  `¯23Åü` binary(1) NOT NULL,
  `º´®æðlÕ` multilinestring DEFAULT NULL,
  `Q5öÏÚÙûÑð` geometrycollection DEFAULT NULL,
  `g^µ<wéHÌó)+<®:áßÕ{Â--Qp°!â|%ÉÇ¸-ãu¸8f±ä^;ò` int(10) unsigned NOT NULL DEFAULT '100001',
  `¨õ^£@.p'tñsÔÕ)³` time NOT NULL DEFAULT '13:31:31',
  `P÷w§ª5[Ãá8wJ¼´6WÑ¨¶YN·^äÀ8>wÈ9ÙfÆzÇP#éî_h` datetime NOT NULL DEFAULT '2012-04-19 11:01:07',
  `õÖ!>` longtext NOT NULL,
  `õÎ;¨=Þ1µÝ6£ípyoü@Õæu,bãcWg^FJa FÐFA` mediumtext NOT NULL,
  `Á2í?kÌ@Y	éÊüyCætÉX` smallint(5) unsigned zerofill NOT NULL DEFAULT '00000',
  `:Ð7ûÛ#Ýx½²±Dli PdñÀ¼3ÈÌÝ¯` char(249) CHARACTER SET utf8 NOT NULL DEFAULT 'sfmgdvi',
  `Ï¥ó$í¤Ùíç[4x|xE7|vÍµ:6eö%÷ª` multipoint NOT NULL,
  `%èöE¯,ÜkºÛÓ¨yLIä*ÿ¬y"e]p^ýHçPýË}ëa´#ð` decimal(15,1) unsigned zerofill DEFAULT '00000000001323.0',
  `b*¸
o©A»¦mëæLÇ*©ÌÂÀ` date DEFAULT '2012-11-26',
  `Î·xçîØ»ÚKtÌï{ã¿ª:Xèd±ÌIF¢aÃÏ-°îhÆ¢§` double unsigned DEFAULT '1521.3673',
...
³Vpºkze9Eã2
Pº0Û)kQÉ
}ÙócSEÉ»¡åÄ¶v)Ñ¼ó*»Ï` point DEFAULT NULL,
  `í{>4þ¯dU0õ°_@ì*Ç_` timestamp NOT NULL DEFAULT '2012-12-28 11:58:27',
  `P^ñË÷'Û2z<o-®¸ÈÓ5Ëä	ð1üRûÿ\.cûµùR@âéô` date DEFAULT '2013-10-17',
  PRIMARY KEY (`Zcï3÷Ë³¾aÈ©J`,`@&`,`¦?Jjá¦~.F¨	a£Z^»;ê`),
  UNIQUE KEY `idx10` (`>3×¾>/ú`),
  KEY `idx0` (`Zcï3÷Ë³¾aÈ©J`,`@&`,`¦?Jjá¦~.F¨	a£Z^»;ê`),
  KEY `idx1` (`ÎY,w¡Z«s>ÿúÙ÷éßõ2Êû«3´ê8é'mñ}XRÝ¨`) USING BTREE,
  KEY `idx2` (`%èöE¯,ÜkºÛÓ¨yLIä*ÿ¬y"e]p^ýHçPýË}ëa´#ð`,`@&`,`kà0£ðm I÷éC-ôWÝ-ëì,Ä\Æ¢ôñRî¨aÃ~vO`,`b*¸
o©A»¦mëæLÇ*©ÌÂÀ`,`P^ñË÷'Û2z<o-®¸ÈÓ5Ëä	ð1üRûÿ\.cûµùR@âéô`),
  KEY `idx3` (`*`) USING BTREE,
  KEY `idx4` (`o-bsÕ*àË]*\7ÿlí!ª²è­y¼en;J'ª¨³R1ò6;Éz¢`) USING HASH,
  KEY `idx7` (`ÔÑeÑL%íô¯×®á²¯Eà3¥h¢aÝ&É¦<_ØÃôF_BiNþ*d	h®÷çûEÛ`) USING BTREE,
  KEY `idx9` (`%èöE¯,ÜkºÛÓ¨yLIä*ÿ¬y"e]p^ýHçPýË}ëa´#ð`,`ôR*ýÝÏFÊÇg3¾\Kg¬p¡p¶ÃÕÑ®ý
Ä`),
  KEY `idx12` (`õÎ;¨=Þ1µÝ6£ípyoü@Õæu,bãcWg^FJa FÐFA`(59)) USING HASH,
  KEY `idx13` (`>3×¾>/ú`) USING BTREE,
  KEY `idx15` (`í{>4þ¯dU0õ°_@ì*Ç_`,`¯23Åü`,`KÍP_ý)\joÚÒæ2ÿ(yxTÈuÊÜ³½Vp¤CÙ`,`º¹ÙÅ@aN}Ñ½Mó-°/4ýûà¸k<+½I$¨§©d7I`),
  KEY `idx17` (`P÷w§ª5[Ãá8wJ¼´6WÑ¨¶YN·^äÀ8>wÈ9ÙfÆzÇP#éî_h`,`zpÜ·©ºsúpÜ¿tXþ¿
e}UqJQ~WèKÃQ*÷Ä»`,`P^ñË÷'Û2z<o-®¸ÈÓ5Ëä	ð1üRûÿ\.cûµùR@âéô`,`¨õ^£@.p'tñsÔÕ)³`),
  KEY `idx18` (`í{>4þ¯dU0õ°_@ì*Ç_`),
  KEY `idx19` (`>3×¾>/ú`,`èFàVa²N0¿ûcDJÿ{£`,`ÔÑeÑL%íô¯×®á²¯Eà3¥h¢aÝ&É¦<_ØÃôF_BiNþ*d	h®÷çûEÛ`),
  KEY `idx20` (`ùº¨0%Ìxs]%øÃëÊ?U`,`YOànfç¶|?ôh¤½â9C¿àebT^µj`,`º¹ÙÅ@aN}Ñ½Mó-°/4ýûà¸k<+½I$¨§©d7I`,`)ø2ÛáDÜaâ8Rè«®L`),
  KEY `idx23` (`P^ñË÷'Û2z<o-®¸ÈÓ5Ëä	ð1üRûÿ\.cûµùR@âéô`,`±`),
  KEY `idx24` (`ùº¨0%Ìxs]%øÃëÊ?U`,`Ru-Ù?
D?Ì!ÛyVTÌ-ã`) USING BTREE,
  KEY `idx26` (`kà0£ðm I÷éC-ôWÝ-ëì,Ä\Æ¢ôñRî¨aÃ~vO`,`Î·xçîØ»ÚKtÌï{ã¿ª:Xèd±ÌIF¢aÃÏ-°îhÆ¢§`,`ùº¨0%Ìxs]%øÃëÊ?U`,`g^µ<wéHÌó)+<®:áßÕ{Â--Qp°!â|%ÉÇ¸-ãu¸8f±ä^;ò`,`P÷w§ª5[Ãá8wJ¼´6WÑ¨¶YN·^äÀ8>wÈ9ÙfÆzÇP#éî_h`),
  KEY `idx27` (`ùº¨0%Ìxs]%øÃëÊ?U`,`ÔÑeÑL%íô¯×®á²¯Eà3¥h¢aÝ&É¦<_ØÃôF_BiNþ*d	h®÷çûEÛ`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `hâæøta³	åñãñ¬ávpöut?íûh<u´u6üí½¦ ãí´9k=ôðê"±ìýx`
--

DROP TABLE IF EXISTS `hâæøta³	åñãñ¬ávpöut?íûh<u´u6üí½¦ ãí´9k=ôðê"±ìýx`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `hâæøta³	åñãñ¬ávpöut?íûh<u´u6üí½¦ ãí´9k=ôðê"±ìýx` (
  `a8` int(10) unsigned zerofill NOT NULL DEFAULT '0000000000',
  `»þ¡ÈpÒ2ÉhE"Æ
´Ú` bit(44) NOT NULL DEFAULT b'11000011010100000',
  `ÌÚ{Êò{)å¡Feë´?ÿÛå¨%Î½ízÅ4ºf±¾XË;` char(141) CHARACTER SET utf8 NOT NULL,
  `ifß±¢{v8+G»cdPDîIø}8¤N£qh ,Æ #ÊÃ3ïa33-f0^!` smallint(6) DEFAULT '0',
  `ß` geometry NOT NULL,
  `Úþ«(H¥oOL=î}u{oq³ø§élò` date DEFAULT '2013-05-28',
  `iFÏ	a*¹ý¤!º+&#¯LÖy
[âçn03Eðb'ò«.y§:Ð` multipoint NOT NULL,
  `A6ºO8­Ô*<` binary(1) NOT NULL,
  `S¡èÕ>ÝCQ PÚô#÷2Tió!l´¾äú+daÿØÂAV` geometry NOT NULL,
  `Û<3Ñ©r {ÕWÂa}8a±ºä_KËØZzÒÖæUmbk fqTéAÁå³ZkaÖÉõP` varbinary(243) NOT NULL,
  `âAÎíýKb$Åð%|Ò&!Qàí±ÂíF` blob NOT NULL,
  `Cò"
e06/±ÎãADÎz` date NOT NULL DEFAULT '2013-06-12',
  `=\Ha-"âos²ûÒh8±ÛaUU` mediumblob NOT NULL,
  `a
ê°$9b}¤}ºwlë
Ðl-ÐðO` timestamp NOT NULL DEFAULT '2013-10-02 14:14:16',
  `ÊÀÍÙ§úå½	ónE9]éföÝh¿|²a#[aPaùöWnØá(ö` bit(43) DEFAULT b'11001100100',
  `ïÎý¡pÏò9Ùëÿ»}Üß^Û[ãv¦ãñoÝØTæcÕYãaýLô
Ã\( ¿/bîÎ;K[^gR` set('g','bqlxzvaq','jdjqa','','ajuycjms','l','b','tallvpc','aohl','rrkmf','is','cljtffvp','','uj','fhccvion','xjfkelvppf','','eq','','ih','ygtfc','wqcjwqatx','fl','roerworad','ewbcvrgocu','spbnit','xtdhaj','m','ftymwfdp','zroc','pirgtwm','shtlpmjewc','oveweqe','zmsglkeg','zlnzr','blahtwinq','ufctda','fw','fnslcxz','jseho','gfgaecqqj','kjyhq','teic','fplpegtofh','','fu','dbpldcboec','kjlgvk','','yfszfj','fslllhiky','dlrjofzdki','fpmcjj','srjwxrhy','wmgla','mjxysz','zrytmlcs','jqdilnjg') NOT NULL,
  `íJgìz0ÎÃ` text NOT NULL,
  `¯&` double DEFAULT '-4.53e47',
  `_iÿµ[v^È^à½¡<jþ°9´³FÚ_Ï·l.ßaÂT*5bZÉiä¡ê»â¾R` bigint(20) unsigned NOT NULL DEFAULT '871022800000',
  `<¯X` geometry NOT NULL,
  `ê0ÇGÆÖüúl¦ñF` timestamp NOT NULL DEFAULT '2012-12-17 11:52:42',
  `¶àü_À±¨£éHÅ@jïìÏÀ°ôé4Î` float NOT NULL DEFAULT '100000',
  `2gíèqõh@m¸Ù#0o¢HËÙÁõ!½ÀÓK
hÎ)ZÕbÚÖN®Q._ÀÏÅÅ;y¿â.` mediumint(8) unsigned NOT NULL DEFAULT '0',
  `ÈòüþªaÀuÁ'êØ&â¼µ8õf|Ûcôf)íí7x` binary(1) NOT NULL,
  PRIMARY KEY (`2gíèqõh@m¸Ù#0o¢HËÙÁõ!½ÀÓK
hÎ)ZÕbÚÖN®Q._ÀÏÅÅ;y¿â.`,`A6ºO8­Ô*<`,`¶àü_À±¨£éHÅ@jïìÏÀ°ôé4Î`,`ÌÚ{Êò{)å¡Feë´?ÿÛå¨%Î½ízÅ4ºf±¾XË;`(99),`a8`),
  UNIQUE KEY `idx86` (`a
ê°$9b}¤}ºwlë
Ðl-ÐðO`,`ïÎý¡pÏò9Ùëÿ»}Üß^Û[ãv¦ãñoÝØTæcÕYãaýLô
Ã\( ¿/bîÎ;K[^gR`,`a8`),
  KEY `idx79` (`ß`),
  UNIQUE KEY `idx87` (`íJgìz0ÎÃ`(15)) USING BTREE,
  KEY `idx62` (`¯&`) USING HASH,
  KEY `idx66` (`Û<3Ñ©r {ÕWÂa}8a±ºä_KËØZzÒÖæUmbk fqTéAÁå³ZkaÖÉõP`(92)) USING BTREE,
  KEY `idx67` (`=\Ha-"âos²ûÒh8±ÛaUU`(141)) USING BTREE,
  KEY `idx68` (`=\Ha-"âos²ûÒh8±ÛaUU`(82)),
  KEY `idx76` (`A6ºO8­Ô*<`),
  KEY `idx78` (`a8`),
  KEY `idx80` (`_iÿµ[v^È^à½¡<jþ°9´³FÚ_Ï·l.ßaÂT*5bZÉiä¡ê»â¾R`),
  KEY `idx82` (`Úþ«(H¥oOL=î}u{oq³ø§élò`),
  KEY `idx84` (`ÈòüþªaÀuÁ'êØ&â¼µ8õf|Ûcôf)íí7x`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2013-04-10 13:19:24
